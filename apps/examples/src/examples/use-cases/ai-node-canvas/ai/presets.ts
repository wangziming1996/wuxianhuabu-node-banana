...
export const WORKFLOW_PRESETS: WorkflowPreset[] = [
  ...
  },
  {
    ...
    category: '设计',
    title: '产品六视图',
    description: '基于参考图产品生成 16:9 六视图(正/侧/背/俯/后侧/顶)',
    prompt:
      '以参考图中出现的产品为唯一主体，生成一张 16:9 横向画幅的产品六视图：正视图、侧视图、后视图、俯视图、后侧视图、顶视图。\n' +
      '硬性要求：\n' +
      '1) 六个视角的必须是【同一个产品】，与参考图中的产品保持完全一致：材质、颜色、纹理、比例、细节、表面特征、logo 位置、零件装配关系都不允许变。\n' +
  ...
  },
  {
    ...
    category: '设计',
    title: '九宫格灯光',
    description: '同一参考图主体的 3x3 九宫格,展示 9 种专业摄影打光方案',
    prompt:
      '以参考图中的人物/产品主体为唯一拍摄对象，生成一张 16:9 横向画幅的 3x3 专业打光对比图(contact sheet)。\n' +
      '硬性要求：\n' +
      '1) 必须是 3 行 3 列共 9 个完全分隔的独立面板，规整网格布局，每格大小相等、九格对齐。\n' +
      '2) 9 个面板里出现的是【同一个主体】——和参考图完全一致的外貌、姿势、服装、造型、表情、构图框架(机位/景别不变)。\n' +
      '3) 9 个面板之间【只允许打光方案不同】。每个面板使用一种截然不同的专业摄影布光：\n' +
      '   Panel 1 - 高级米色编辑光:柔光大八角箱,米色渐变背景,奢侈时尚大片氛围。\n' +
      '   Panel 2 - 高调美妆商业光:几乎无影的高亮布光,白到天蓝无缝背景,皮肤高光发光。\n' +
      '   Panel 3 - 深棕剪影肖像光:强侧光,深棕渐变背景,肩部轮廓光,电影感剪影。\n' +
      '   Panel 4 - 冷蓝科技光:冷蓝色调主光,深蓝到青灰渐变背景,产品金属反射清晰。\n' +
      '   Panel 5 - 黄昏窗光:暖色侧窗光穿过百叶,长投影,情绪化氛围。\n' +
      '   Panel 6 - 高级产品广告光:强侧光 + 锐利高光边缘,冷白背景,真实阴影投影,消费品广告质感。\n' +
      '   Panel 7 - 现代蓝调商业光:冷蓝渐变背景,柔光定向,光泽面料反射,科技商业氛围。\n' +
      '   Panel 8 - 高级眼镜背光:亮白背景,强侧背光,清晰轮廓光,高端眼镜广告氛围。\n' +
      '   Panel 9 - 高反差美妆特写:微距美妆光,极致皮肤质感,受控高光,锋利面部轮廓,奢华护肤广告质感。\n' +
      '4) 不要仅靠换背景色来"假装"换了光。每个面板必须呈现出可识别的独特布光逻辑(光源方向/质感/阴影/高光位置都不同)。\n' +
      '5) 不添加文字、标志、商标、水印、UI 元素。9 个面板之间没有任何文字说明。',
    recommendedModel: 'agnes-image-2.0-flash',
    size: '16:9',
    count: 1,
    presetFor: ['image', 'custom'],
